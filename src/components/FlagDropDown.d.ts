...
import CountryList, { CountryListProps, CountryListState } from './CountryList'

export type FlagDropDownProps = {
...
export type FlagDropDownState = {

}

export default class FlagDropDown extends React.Component<FlagDropDownProps, FlagDropDownState> {
